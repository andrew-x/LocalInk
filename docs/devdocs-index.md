...
| OpenRouter native image models API | https://openrouter.ai/api/v1/images/models | Authoritative list of `/api/v1/images` models with per-model `resolution` and `aspect_ratio` enums; native image models are absent from `/api/v1/models`. | 2026-09-11 |
