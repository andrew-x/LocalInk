...
- `docs/ai-image-generation.md`: image generation via OpenRouter (plus the dormant WaveSpeed path), local generated-image storage, routes, and privacy/logging rules.
